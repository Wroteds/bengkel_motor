        ...
        <tbody>
            ...
            <tr>
                ...
                <td data-label="Status">
                    <span class="badge 
                        {{ $booking->status == 'pending' ? 'bg-warning' : ($booking->status == 'proses' ? 'bg-info' : ($booking->status == 'batal' ? 'bg-danger' : 'bg-success')) }}">
                ...
                <form action="{{ route('admin.bookings.updateStatus', $booking->id) }}" method="POST" class="d-inline">
                    ...
                    <td data-label="Waktu Selesai">
                        <input type="datetime-local" name="completion_time" value="{{ $booking->completion_time ? \Carbon\Carbon::parse($booking->completion_time)->format('Y-m-d\TH:i') : '' }}" class="form-control form-control-sm">
                    </td>
